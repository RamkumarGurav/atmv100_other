                            ...
                            <div class="divTable">
                                <div class="TableRow">
                                    ...
                                    <div class="table_col">
                                        ...
                                        <?php if (!empty($branch_data->added_on)) {
                                            echo date("d-m-Y h:i:s A", strtotime($branch_data->added_on));
                                        } else {
                                            echo "-";
                                        } ?>
                                    </div>
                                ...
                                <div class="TableRow">
                                    <div class="table_col">
                                        ...
                                        <?php if (!empty($branch_data->added_by_name)) {
                                            echo $branch_data->added_by_name;
                                        } else {
                                            echo "-";
                                        } ?>
                                    </div>
