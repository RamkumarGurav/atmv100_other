...
if (!empty($shift_timing_data)) {
    ...
    // $branch_id = $shift_timing_data->branch_id;
    // $branch_name = $shift_timing_data->branch_name;
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">
                            <?php if (!empty($shift_timing_data->login_time)): ?>
                                <?= (new DateTime($shift_timing_data->login_time))->format('h:i A'); ?>
                            <?php else: ?>
                                -
                            <?php endif; ?> to <?php if (!empty($shift_timing_data->logout_time)): ?>
                        ...
                        <div class="float-right">
                            ...
                            if ($user_access->add_module == 1 && false) {
                                ?>
                                <a href="<?= MAINSITE_Admin . $user_access->class_name ?>/shift-timing-edit">
                            ...
                            if ($user_access->update_module == 1) {
                                ?>
                                <a
                                    href="<?= MAINSITE_Admin . $user_access->class_name ?>/shift-timing-edit/<?= $shift_timing_data->shift_timing_id ?>">
                    ...
                    if ($user_access->view_module == 1) {
                        ...
                        <div class="card-body">
                            ...
                            <?php echo form_open(MAINSITE_Admin . "$user_access->class_name/shift-timing-doUpdateStatus", array('method' => 'post', 'id' => 'ptype_list_form', "name" => "ptype_list_form", 'style' => '', 'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data')); ?>
                            ...
                            <div class="divTable">
                                <div class="TableRow">
                                    <div class="table_col">
                                        ...
                                        <?= $shift_timing_data->shift_timing_id ?>
                                    </div>
                                    <div class="table_col">
                                        <label class="label_content_br">Login Time <span class="colen">:</span></label>
                                        <?php if (!empty($shift_timing_data->login_time)): ?>
                                            <?= (new DateTime($shift_timing_data->login_time))->format('h:i A'); ?>
                                        <?php else: ?>
                                            -
                                    ...
                                    <div class="table_col">
                                        <label class="label_content_br">Logout Time <span class="colen">:</span></label>
                                        <?php if (!empty($shift_timing_data->logout_time)): ?>
                                            <?= (new DateTime($shift_timing_data->logout_time))->format('h:i A'); ?>
                                        <?php else: ?>
                                            -
                                        <?php endif; ?>
                                    ...
                                    <div class="table_col">
                                        ...
                                        <? if (!empty($shift_timing_data->added_on)) {
                                            echo date("d-m-Y h:i:s A", strtotime($shift_timing_data->added_on));
                                        } else {
                                            echo "-";
                                        } ?>
                                    </div>
                                    ...
                                    <div class="table_col">
                                        ...
                                        <? if (!empty($shift_timing_data->added_by_name)) {
                                            echo $shift_timing_data->added_by_name;
                                        } else {
                                            echo "-";
                                        } ?>
                                    </div>
                                ...
                                <div class="TableRow">
                                    <div class="table_col">
                                        ...
                                        <? if (!empty($shift_timing_data->updated_on)) {
                                            echo date("d-m-Y h:i:s A", strtotime($shift_timing_data->updated_on));
                                        } else {
                                            echo "-";
                                        } ?>
                                    </div>
                                    <div class="table_col">
                                        ...
                                        <? if (!empty($shift_timing_data->updated_by_name)) {
                                            echo $shift_timing_data->updated_by_name;
                                        } else {
                                            echo "-";
                                        } ?>
                                    </div>
                                    <div class="table_col">
                                        ...
                                        <? if ($shift_timing_data->status == 1) { ?> Active <i
