                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="field_name" id="field_name" class="form-control"
                                                    ...
                                                    <option value='ft.ip_address' <?php if ($field_name == 'ft.ip_address') {
                                                        echo 'selected';
                                                    } ?>>IP   Address
                                                    </option>
                    ...
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            if ($user_access->add_module == 1) {
                                ?>
                                <a href="<?php echo MAINSITE_Admin . $user_access->class_name ?>/ip-address-edit">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($ip_address_data as $urm) {
                                            ...
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <td><a
                                                        href="<?php echo MAINSITE_Admin . $user_access->class_name . "/ip-address-view/" . $urm->ip_address_id ?>"><?php echo $urm->ip_address ?></a>
                                                </td>
                                                <td><?php if (!empty($urm->added_on)): ?>
                                                        <?php echo date("d-m-Y", strtotime($urm->added_on)) ?>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?>
                                                </td>
                                                <td><?php if (!empty($urm->added_by_name)): ?>
                                                        <?php echo $urm->added_by_name ?>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?>
                                                </td>
                                                <td><?php if (!empty($urm->updated_on)): ?>
                                                        <?php echo date("d-m-Y", strtotime($urm->updated_on)) ?>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?>
                                                </td>
                                                <td><?php if (!empty($urm->updated_by_name)): ?>
                                                        <?php echo $urm->updated_by_name ?>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?>
                                                </td>
