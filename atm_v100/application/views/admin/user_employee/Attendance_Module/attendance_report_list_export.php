<?php 
	...
	$filename = "Atendance-Report-" . date('d-m-Y') . ".xls"; header("Content-Disposition: attachment; filename=\"$filename\""); 
...
<br />&nbsp;
                                        ...
                                        <tr >
											...
											<th style="background-color:#999" width="*">Total Late Logins</th>
											<th style="background-color:#999" width="*">Total Early Logouts</th>
											<th style="background-color:#999" width="*">Total Absent Days</th>
