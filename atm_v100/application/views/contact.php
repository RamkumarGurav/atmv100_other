            ...
            <div class=" d-flex align-items-center justify-content-center">
              <div class="bd-breadcrumb-content text-center">
                ...
                <div class="bd-breadcrumb-list" style="margin-bottom:50px;">
                  <span><a href="index.html"><i class="fa fa-home"></i>Home</a></span>
      ...
      <div class="row gy-24">
        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
          <div class="contact-box">
            <div class="contact-icon mb-30"><i class="fa-light fa-phone"></i></div>
            <h5 class="contact-title mb-15">Call Us On</h5>
            <div class="contact-content">
              <a href="tel:+919980808500">+91 9980808500</a>
            </div>
          </div>
        </div>
        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
          <div class="contact-box">
            <div class="contact-icon mb-30"><i class="fa-light fa-envelope"></i></div>
            <h5 class="contact-title mb-15">Email Us</h5>
            <div class="contact-content">
              <a href="mailto:info@prachitourism.com">info@prachitourism.com</a>
            </div>
          </div>
        </div>
        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
          <div class="contact-box">
            <div class="contact-icon mb-30"><i class="fa-light fa-location-pin"></i></div>
            <h5 class="contact-title mb-15">Our Location</h5>
            <div class="contact-content">
              <a href="#">1762, 41st cross, 18 Main Road</a>
              <a href="#">Jayanagar 4th T Block , Bengaluru</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row gy-24 justify-content-between">
        <div class="col-xxl-5 col-xl-5 col-lg-6">
          <div class="section-title-wrapper">
            ...
            <h3 class="section-title mb-15">For a customized tour and adventure experience!</h3>
            <p>you can contact us. We are specialize in tailor-made travel packages</p>
            <div class="section-divider mb-25"></div>
            <div class="contact-social">
              <span class="contact-social-title d-block mb-30">Follow Us here:</span>
              <div class="social-menu">
                <div class="theme-social">
                  <a href="https://www.facebook.com/profile.php?id=61555534820918&mibextid=ZbWKwL"
                  ...
                  <a href="https://www.instagram.com/escapefromreality_99?igsh=MXYxYXE4YndzMXphcA=="
                    target="_blank"><i><svg width="24px" height="24px" viewBox="0 0 24 24" fill="#fff"
                  ...
                  <a href="https://www.youtube.com/@EscapeFromReality922" target="_blank"><i><svg
                  ...
                  <!-- <a href="#"><i><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                          d="M21.7 8.037a4.26 4.26 0 0 0-.789-1.964 2.84 2.84 0 0 0-1.984-.839c-2.767-.2-6.926-.2-6.926-.2s-4.157 0-6.928.2a2.836 2.836 0 0 0-1.983.839 4.225 4.225 0 0 0-.79 1.965 30.146 30.146 0 0 0-.2 3.206v1.5a30.12 30.12 0 0 0 .2 3.206c.094.712.364 1.39.784 1.972.604.536 1.38.837 2.187.848 1.583.151 6.731.2 6.731.2s4.161 0 6.928-.2a2.844 2.844 0 0 0 1.985-.84 4.27 4.27 0 0 0 .787-1.965 30.12 30.12 0 0 0 .2-3.206v-1.516a30.672 30.672 0 0 0-.202-3.206Zm-11.692 6.554v-5.62l5.4 2.819-5.4 2.801Z"
          ...
          <div class="google-map mt-5">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.824699587538!2d77.58930327575513!3d12.91898591602825!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae15090cd6f51b%3A0x1826a91e5425024d!2s1762%2C%2041st%20Cross%20Rd%2C%20Kottapalya%2C%20Jayanagara%209th%20Block%2C%20Jayanagar%2C%20Bengaluru%2C%20Karnataka%20560041!5e0!3m2!1sen!2sin!4v1719670910598!5m2!1sen!2sin"
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-6">
          <div class="contact-form">
            ...
            <form name="enqForm" id="Contact-us" action="<?= MAINSITE . 'ajax_insert_enquiry' ?>"
              ...
              <!-- <form id="enquiry-form" onsubmit="ajax_insert_enquiry(); return false;"> -->
              <input type="hidden" class="inputText" id="subject" name="subject" value="normal enquiry">
              <input type="hidden" name="page" id="page" value="contact" />
              <div class="row gy-24">
                <div class="col-md-12">
                  <div class="floating-form-input">
                    <input type="text" class="inputText" id="name" name="name" attern="(?=.*[A-Za-z])[A-Za-z\s]*"
                      required="required" data-parsley-required-message="Name is required" />
                ...
                <div class="col-md-12">
                  <!-- <div class="contact-form-check mb-20">
                    <label class="footer-form-check-label has-black">
                  ...
                  <div class="contact-form-btn">
                    <button class="g-recaptcha bd-primary-btn btn-style has-arrow is-bg radius-60"
                      data-callback="onSubmit" style="pointer-events: all; cursor: pointer;"
                      data-sitekey="<?= _google_recaptcha_site_key_ ?>" data-action="submit">
...
<script>
  ...
  function onSubmit(token) {
    ...
    alert($("#Contact-us").parsley().isValid());
    //contactvalidateForm();
...
<script>
  ...
  //   $.ajax({
  //     url: "<?= MAINSITE . 'ajax_insert_enquiry' ?>",
  //     type: 'post',
  //     data: formData,
  //     success: function (response) {
  //       toastrDefaultSuccessFunc("Message sent Successfully!");
  //       clearForm();
